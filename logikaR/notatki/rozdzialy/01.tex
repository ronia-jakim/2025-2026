...
Atomizm logiczny - każde zdanie można zredukować do zdań atomowych, których już dalej się rozbić nie da. Nie obchodzi nas tutaj nadmiernie spełnianie zdań.
...
\begin{definition}{tautologia}{}
  Niech $\phi\in\mathcal{F}_L$. Wtedy $\phi$ jest \buff{tautologią} klasycznego rachunku logicznego, gdy jest zawsze prawdziwe. Zapisujemy to $\models\phi$, co oznacza $\forall\;\Mm$ modelu $L$ $\Mm\models\phi$.
\end{definition}
