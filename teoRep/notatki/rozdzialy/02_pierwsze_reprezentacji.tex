...
\begin{lemma}{Schura}{}
  Niech $\rho_i:G\to GL(V_i)$, $i=1,2$ będą dwoma nieprzywiedlnimi reprezentacjami grupy $G$. Niech $f:V_1\to V_2$ będzie liniowym odwzorowaniem takim, że $\rho_2f=f\rho_1$. Wtedy
  \begin{enumerate}
...
\begin{theorem}{}{}
  Reprezentacja $V$ o charakterze $\chi$ jest nieredukowalna $\iff$ $\langle\chi,\chi\rangle=1$
\end{theorem}
...
\begin{proof}
  Oznaczmy
  $$C^+_c(G)=\{f\in C_c(G)\;:\;f\geq 0\;\land\;f\not\equiv 0\}$$
  liniowe kombinacje elementów tego zbioru dają całe $C_c(G)$.


  Używamy twierdzenia o fix-punkcie, co jest niekonstruktywną zabawką.
