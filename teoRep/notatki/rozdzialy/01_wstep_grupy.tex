...
Innym przyjemną własnością grup zwartych jest istnienie na nich miary niezmienniczej na przesunięcia, nazywanej \acc{miarą Haara}. Nie jest to jednak cecha wyłączna dla grup zwartych. Warunek zwartości można osłabić, nie tracąc przy tym istnienia miary Haara. Do kontemplowania miary Haara wrócimy w przyszłości.
...
\section{Moduły, produkt tensorowy}

W tej części notatki przez $R$ będziemy rozumieć pierścień z jednością.

\begin{definition}{moduły}{}
  Powiemy, że $M$ jest lewym $R$-modułem, jeśli 
  \begin{itemize}
    \item $M$ jest grupą abelową z dodawaniem,
    \item na której działa pierścień $R$.
  \end{itemize}
\end{definition}
