...
Na tę chwilę będą interesować nas unitarne reprezentacje grup skończonych, czyli homomorfizmy $G\to U(\Hh)$, gdzie $U(\Hh)$ to grupa unitarnych przekształceń przestrzeni Hilberta $\Hh$. Do ciekawszego przypadku unitarnych reprezentacji grup zwartych przejdziemy w rozdziale \ref{chapter:reprezentacje unitarne}.
...
Jeśli $\rho:G\to GL(V)$ i $\rho':G\to GL(V')$ są reprezentacjami $G$, to możemy zdefiniować reprezentację (przypomnijmy, że reprezentacja grupy to po prostu jej działanie na przestrzeni liniowej) $G$ na $V\otimes V'$ w następujący sposób:
...
\begin{definition}{produkt symetryczny}{}
  ...
  $$S^n(V):=V^{\otimes n}/\langle v_1\otimes..\otimes v_i\otimes v_{i+1}\otimes...\otimes v_n-v_1\otimes...\otimes v_{i+1}\otimes v_i\otimes ... \otimes v_n\rangle.$$
\end{definition}
...
\begin{definition}{produkt alternujący}{}
  ...
  $$\Lambda^n(V):=V^{\otimes n}/\langle v_1\otimes..\otimes v_i\otimes v_{i+1}\otimes...\otimes v_n+v_1\otimes...\otimes v_{i+1}\otimes v_i\otimes ... \otimes v_n\rangle.$$
\end{definition}
